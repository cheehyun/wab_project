...
<body>
	...
	<footer class="footer" style="background-color: lightgray;">
      <div class="container">
      	<p class "copyright text-muted large">public class </p>
      	<p class "copyright text-muted large">program </p>
      	<p class "copyright text-muted large"> void main</p>
        <p class="copyright text-muted large">(주)회사명 사업자번호 : 123-45-67890 / 통신판매업신고번호 : !@#!@##$#@$!</p>
        <p class="copyright text-muted large">대표 : killer / 대충 회사 주소 / 대표전화 : (01)123-4567</p>
        <p class="copyright text-muted large">Copyright &copy; PERPECTKILLER Co.,Ltd. All Rights Reserved</p>
      </div>
    </footer>
